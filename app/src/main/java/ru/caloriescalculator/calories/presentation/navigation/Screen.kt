...
sealed class Screen(val title: String, val icon: ImageVector, val route: String) {
    ...
    object AddCalories : Screen(title = "Добавить калории", icon = Icons.Default.Add, route = "add_calories_screen")
    object Products : Screen(title = "Продукты", icon = Icons.Default.ShoppingCart, route = "products_screen")
    object AddProduct : Screen(title = "Добавить продукт", icon = Icons.Default.Add, route = "add_product_screen")
}
